...
A large number of standalone technical reports were written during the development of the content for the book. The book is the primary source now, but if you really really want to see these now outdated technical reports: "click here":workspace/README.textile and scroll down.
