...
* Jason Brownlee. "Algorithm Description: Random Search":http://github.com/jbrownlee/CleverAlgorithms/raw/master/workspace/release/techreport-20100129-1.pdf. Technical Report CA-TR-20100129-1, The Clever Algorithms Project http://www.CleverAlgorithms.com, January 2010.
...
Found a typo or a bug in the source code? Are you an expert in this technique and know some facts that could improve the algorithm description for all? Do you want to get that warm feeling from contributing to an open source project? Do you want to see your name as an acknowledgment in print?

Two pillars of this effort are i) that the domain experts are those people outside of the project, and ii) that the work is wrong by default. Help us make this work less wrong.
