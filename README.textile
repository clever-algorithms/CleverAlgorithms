...
The book is available in paperback, free PDF, and a free website.
...
* "web":http://github.com/jbrownlee/CleverAlgorithms/tree/master/web/ : Scripts for generating HTML and eBook (ePub) versios of the book's content. 
