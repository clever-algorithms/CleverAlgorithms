...
\begin{algorithm}[htp]
	...
	% caption
	\caption{Pseudocode for the \texttt{MemoryBasedReaction} function.}
...
\begin{algorithm}[ht]
	...
	\Return{\Current}\;
	% caption
	\caption{Pseudocode for the \texttt{BestMove} function.}
	\label{alg:best_move}
\end{algorithm}
...
\begin{algorithm}[ht]
	...
	\Return{\Tabu}\;
	% caption
	\caption{Pseudocode for the \texttt{IsTabu} function.}
	\label{alg:tabu}
\end{algorithm}
