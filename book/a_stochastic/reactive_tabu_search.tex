...
\begin{algorithm}[Htp]
	...
	\Return{\Best}\;
	% caption
	\caption{Pseudocode for the Reactive Tabu Search algorithm.}
...
\begin{algorithm}[Htp]
	...
	% caption
	\caption{Pseudocode for the \texttt{MemoryBasedReaction} function in the Reactive Tabu Search algorithm.}
...
\begin{algorithm}[ht]
	...
	\Return{\Current}\;
	% caption
	\caption{Pseudocode for the \texttt{BestMove} function in the Reactive Tabu Search algorithm.}
	\label{alg:best_move}
\end{algorithm}
...
\begin{algorithm}[ht]
	...
	\Return{\Tabu}\;
	% caption
	\caption{Pseudocode for the \texttt{IsTabu} function in the Reactive Tabu Search algorithm.}
	\label{alg:tabu}
\end{algorithm}
