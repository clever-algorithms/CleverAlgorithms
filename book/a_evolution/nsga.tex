...
\begin{algorithm}[htp]
	...
	\Return{\Children}\;
	% end
	\caption{Pseudocode for the Non-dominated Sorting Genetic Algorithm~II.}
	\label{alg:nsga}
\end{algorithm}
...
% the listing
\lstinputlisting[firstline=7,language=ruby,caption=NSGA-II in the Ruby Programming Language, label=nsga]{../src/algorithms/evolutionary/nsga_ii.rb}
