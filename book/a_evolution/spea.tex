...
\begin{algorithm}[htp]
	...
	% end
	\caption{Pseudocode for the Strength Pareto Evolutionary Algorithm 2 (SPEA2).}
	\label{alg:spea}
\end{algorithm}
...
% the listing
\lstinputlisting[firstline=7,language=ruby,caption=SPEA2 in the Ruby Programming Language, label=spea]{../src/algorithms/evolutionary/spea2.rb}
