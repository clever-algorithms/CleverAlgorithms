...
% overview
O'Neill and Ryan provide a high-level introduction to Grammatical Evolution and early demonstration applications \cite{O'Neill1999}. The same authors provide a thorough introduction to the technique and overview of the state of the field \cite{O'Neill2001}.
% books
