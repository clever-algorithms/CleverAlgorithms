...
\begin{algorithm}[ht]
  ...
  \While{$\neg$\StopCondition{}}{
	...
	\Return{\Repertoire}\;	
	\caption{Pseudocode for detector generation in the Negative Selection Algorithm.}
...
\begin{algorithm}[ht]
  ...
  \For{\CurrentInputSample $\in$ \InputSamples}
	...
	\caption{Pseudocode for detector application in the Negative Selection Algorithm.}
