...
\begin{description}
  ...
  \item[page 37] Fixed bug with \texttt{step{\textunderscore}size} in Adaptive Random Search implementation. Thanks to Zach Scott.
	\item[page 43] Typo in Taxonomy section of Iterated Local Search. Thanks to Diego Noble.
	\item[page 129] Bug in the \texttt{one{\textunderscore}point{\textunderscore}crossover} function of the Grammatical Evolution implementation. Thanks to Mark Chenoweth.
	\item[page 235] Fixed a bug in the \texttt{get{\textunderscore}global{\textunderscore}best} function of the Particle Swarm Optimization implementation. Thanks to Paul Chinnery.
