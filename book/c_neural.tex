...
There are many other algorithms and classes of algorithm that are not described in this chapter from the field of Neural Intelligence, not limited to the following:
