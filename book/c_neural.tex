...
\newpage\begin{bibunit}\input{book/a_neural/perceptron}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_neural/backpropagation}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_neural/hopfield_network}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_neural/lvq}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_neural/som}\putbib\end{bibunit}
