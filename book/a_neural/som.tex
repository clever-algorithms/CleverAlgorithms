...
\begin{algorithm}[ht]
	...
	% end
	\caption{Pseudocode for the Self-Organizing Map algorithm.}
	\label{alg:train}
\end{algorithm}
...
% early
This work was tightly related two other papers published at close to the same time on self-organizing topological maps and self-organization \cite{Kohonen1981, Kohonen1982b}.
