...
\newpage\begin{bibunit}\input{book/a_immune/clonal_selection_algorithm}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_immune/negative_selection_algorithm}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_immune/airs}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_immune/immune_network_algorithm}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_immune/dca}\putbib\end{bibunit}
