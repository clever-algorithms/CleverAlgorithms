...
\newpage\begin{bibunit}\input{book/a_probabilistic/pbil}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_probabilistic/umda}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_probabilistic/compact_genetic_algorithm}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_probabilistic/boa}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_probabilistic/cross_entropy}\putbib\end{bibunit}
