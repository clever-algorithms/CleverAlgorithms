...
\newpage\begin{bibunit}\input{book/a_evolution/genetic_algorithm}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/genetic_programming}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/evolution_strategies}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/differential_evolution}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/evolutionary_programming}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/grammatical_evolution}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/gene_expression_programming}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/learning_classifier_system}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/nsga}\putbib\end{bibunit}
\newpage\begin{bibunit}\input{book/a_evolution/spea}\putbib\end{bibunit}
