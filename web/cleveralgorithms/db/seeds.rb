...
# lots of algo names
Algorithm.create!(:name=>"Random Search")
Algorithm.create!(:name=>"Adaptive Random Search")
Algorithm.create!(:name=>"Stochastic Hill Climbing")
Algorithm.create!(:name=>"Iterated Local Search")
Algorithm.create!(:name=>"Guided Local Search")
Algorithm.create!(:name=>"Variable Neighborhood Search")
Algorithm.create!(:name=>"Greedy Randomized Adaptive Search")
Algorithm.create!(:name=>"Scatter Search")
Algorithm.create!(:name=>"Tabu Search")
Algorithm.create!(:name=>"Reactive Tabu Search")

Algorithm.create!(:name=>"Simulated Annealing")
Algorithm.create!(:name=>"Adaptive Simulated Annealing")
Algorithm.create!(:name=>"Memetic Algorithm")
Algorithm.create!(:name=>"Extremal Optimization")
Algorithm.create!(:name=>"Cultural Algorithm")

Algorithm.create!(:name=>"Genetic Programming")
Algorithm.create!(:name=>"Evolutionary Programming")
Algorithm.create!(:name=>"Evolution Strategies")
Algorithm.create!(:name=>"Learning Classifier System")
Algorithm.create!(:name=>"Differential Evolution")
Algorithm.create!(:name=>"Grammatical Evolution")
Algorithm.create!(:name=>"Non-dominated Sorting Genetic Algorithm")
Algorithm.create!(:name=>"Strength Pareto Evolutionary Algorithm")
Algorithm.create!(:name=>"Island Population Genetic Algorithm")

Algorithm.create!(:name=>"Cross-Entropy Method")
Algorithm.create!(:name=>"Population-Based Incremental Learning")
Algorithm.create!(:name=>"Probabilistic Incremental Program Evolution")
Algorithm.create!(:name=>"Compact Genetic Algorithm")
Algorithm.create!(:name=>"Extended Compact Genetic Algorithm")
Algorithm.create!(:name=>"Bayesian Optimization Algorithm")
Algorithm.create!(:name=>"Hierarchical Bayesian Optimization Algorithm")
Algorithm.create!(:name=>"Univariate Marginal Distribution Algorithm")
Algorithm.create!(:name=>"Bivariate Marginal Distribution Algorithm")
Algorithm.create!(:name=>"Gaussian Adaptation")

Algorithm.create!(:name=>"Particle Swarm Optimization")
Algorithm.create!(:name=>"AntNet")
Algorithm.create!(:name=>"Ant System")
Algorithm.create!(:name=>"Max-Min Ant System")
Algorithm.create!(:name=>"Rank-Based Ant System")
Algorithm.create!(:name=>"Ant Colony System")
Algorithm.create!(:name=>"Multiple Ant Colony System")
Algorithm.create!(:name=>"Population-based Ant Colony Optimization")
Algorithm.create!(:name=>"Bees Algorithm")
Algorithm.create!(:name=>"Bacterial Foraging Optimization Algorithm")

Algorithm.create!(:name=>"Clonal Selection Algorithm")
Algorithm.create!(:name=>"Negative Selection Algorithm")
Algorithm.create!(:name=>"Artificial Immune Recognition System")
Algorithm.create!(:name=>"Immune Network Algorithm")
Algorithm.create!(:name=>"Dendritic Cell Algorithm")
