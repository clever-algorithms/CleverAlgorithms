...
\usepackage{textcomp}
% \usepackage{../upquote}
\lstset{basicstyle=\small,numbers=left,numberstyle=\tiny,frame=single,columns=flexible,upquote=true,showstringspaces=false,tabsize=2,captionpos=b}
...
\input{../lua.def}
\lstset{language=lua}
\begin{lstlisting}[caption={Genetic Algorithm in the Lua Programming Language},label=luaga]
NUM_GENERATIONS = 100
NUM_BOUTS = 3
POP_SIZE = 100
NUM_BITS = 64
