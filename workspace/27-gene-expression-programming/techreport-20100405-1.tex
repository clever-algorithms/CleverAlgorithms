...
% seminal
seminal paper by Ferreira \cite{Ferreira2001}
% early
...
% reviews
early overview of the technique as a book chapter \cite{Ferreira2002}

a great overview of the technique as a book chapter \cite{Ferreira2005}

% books

book \cite{Ferreira2006} - introduction to the technique including background, the algorithm, and demonstration applications
