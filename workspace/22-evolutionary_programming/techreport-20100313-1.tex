...
A population of a species reproduce, creating clones with phenotypical variation (mutation). The progeny and the parents compete in a series of tournaments where the overall winners constitute the subsequent generation. This process repeats and the adaptive fit between the species and the environment improves over time.
