...
% overview
O'Neill and Ryan provide a through introduction to the technique and overview of the state of the field \cite{O’Neill2001}.
% books
book on GE: \cite{O'Neill2003}, seminal reference in depth study

applications to dynamic environments \cite{Dempsey2009}, extensions to GE focused on dynamic environments
