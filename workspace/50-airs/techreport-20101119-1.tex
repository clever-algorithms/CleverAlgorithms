...
It is the basis for extensions such as the Parallel Artificial Immune Recognition System.
...
% report
This report described the Artificial Immune Recognition System using the standardized algorithm description template. This report is based on prior work by the author investigating the algorithm \cite{Brownlee2005} and the implementation provided for the WEKA machine learning workbench \url{http://wekaclassalgos.sourceforge.net/}.
