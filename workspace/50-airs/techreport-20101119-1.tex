...
% What are the data structures and representations used in a technique?
AIRS... ARB... memory pool...

% What is the computational recipe for a technique?
Algorithm~\ref{alg:train} provides a high-level pseudo-code for preparing codebook vectors using the Artificial Immune Recognition System. 
...
where $n$ is the number of attributes, $x$ is the input vector and $c$ is a given cell vector.
...
\begin{algorithm}[ht]
	...
	% end
	\caption{Pseudo Code for the Artificial Immune Recognition System.}
	\label{alg:train}
\end{algorithm}
...
% algorithm
The algorithm is an implementation of the AIRS2 algorithm \cite{Watkins2002b}. An initial pool of memory cells is created, one for each class.
