...
\newcommand{\myreporttitle}{Population-Based Incremental Learning}
...
% report
This report describes the Population-Based Incremental Learning algorithm using the standardized template.

\begin{description}
	\item[Keywords:] {\small\texttt{Clever, Algorithms, Description, Optimization, Population-Based, \\Incremental, Learning}}
\end{description} 
...
PBIL is related to other EDAs such as the Compact Genetic Algorithm, the Population Incremental Programing Evolution Algorithm, and the Bayesian Optimization Algorithm. The fact the the algorithm maintains a single prototype vector that is updated competitively shows some relationship to the Learning Vector Quantization algorithm.
...
This is done by reducing the population of a candidate solutions to a single Population vector of attributes from which candidate solutions can be generated and assessed.
...
The Population-Based Incremental Learning algorithm maintains on a real-valued prototype vector that represents the probability of each component being expressed in a candidate solution. 
% What is the computational recipe for a technique?
Algorithm~\ref{alg:pbil} provides a pseudo-code listing of the Population-Based Incremental Learning algorithm for minimizing a cost function.
...
Greene provided one of the first published accounts on the applicability of PBIL as a practical optimization algorithm \cite{Greene1996}.
