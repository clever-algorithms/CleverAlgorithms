...
initially claimed to be a technique for the operational research practitioner
it is a global search technique that guides a local search
...
\begin{algorithm}[ht]
	...
	\SetKwData{RCL}{$RCL$}
	\SetKwData{RCLSize}{$RCL_{size}$}
	% functions
	\SetKwFunction{Cost}{Cost}
	\SetKwFunction{StopCondition}{StopCondition}
	\SetKwFunction{ConstructRandomSolution}{ConstructRandomSolution}
	\SetKwFunction{ConstructGreedyRandomizedSolution}{ConstructGreedyRandomizedSolution}
	...
	\While{$\neg$ \StopCondition{}} {
		...
		\Candidate $\leftarrow$ \ConstructGreedyRandomizedSolution{\RCL, \RCLSize}\;
		% local search
	...
	\Return{\Best}\;
	% caption
	\caption{Pseudo Code Listing for the Greedy Randomized Adaptive Search Procedure.}
	\label{alg:grasp}
\end{algorithm}
...
\begin{itemize}
	...
	\item good review articles \cite{Pitsoulis2002} and \cite{Resende2003}
