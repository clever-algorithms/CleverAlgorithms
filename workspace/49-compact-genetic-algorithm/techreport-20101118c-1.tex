...
The Compact Genetic Algorithm is an Estimation of Distribution Algorithm (EDA), also referred to as also referred to as Population Model-Building Genetic Algorithms (PMBGA) an extension to the field of Evolutionary Computation.
...
The Compact Genetic Algorithm is a Population technique without an inspiration. It is related to the Genetic Algorithm and other Evolutionary algorithms that are inspired by the biological theory of evolution by means of natural selection.
...
Algorithm~\ref{alg:cga} provides a pseudo-code listing of the Compact Genetic Algorithm for minimizing a cost function.
...
% algorithm
The algorithm is an implementation of Compact Genetic Algorithm...
...
% seminal
The Compact Genetic Algorithm was proposed by Harik, Lobo, and Goldberg in 1999 \cite{Harik1999}, based on a random walk model perviously introduced by Harik, et al. \cite{Harik1997}.
% early
