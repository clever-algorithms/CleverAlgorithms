...
\newcommand{\myreporttitle}{Hill Climbing Algorithm}
...
\begin{itemize}
	...
	\item steepest ascent hill climbing: test all neighbours, take best. similar in concept to best-first search (greedy search?)
	\item Stochastic hill climbing: test random neighbours, take best
