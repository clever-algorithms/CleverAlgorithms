...
\newcommand{\myreportdate}{20100203}
...
make random moves in the local neighborhood and accept improving moves 
...
Algorithm~\ref{alg:stochastic_hill_climbing} provides a pseudo-code listing of the Stochastic Hill Climbing algorithm for minimizing a cost function.
...
\begin{itemize}
	...
	\item (forerunner to RMHC?) Evolution in time and space - the parallel genetic algorithm (Muhlenbein)
