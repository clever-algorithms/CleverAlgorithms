...
\newcommand{\myreporttitle}{Stochastic Hill Climbing Algorithm}
...
Stochastic Hill Climbing Algorithm, SHCA, Random Hill Climbing, RHC, Random Mutation Hill Climbing, RMHC 
