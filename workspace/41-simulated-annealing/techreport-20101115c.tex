...
Simulated Annealing is a baseline method that like the Genetic Algorithm provides a basis for a large variety of extensions and specialization's of the general method.
