...
likely to have an adaptive or variable direction as well
...
\begin{itemize}
	...
	\item Adaptive Random Search should adapt both the step size and the direction of the moves in the search space.
	\item The step size should be adapted for each search parameter in continuos function optimization domains.
\end{itemize}
...
% seminal
Schummer and Steiglitz are commonly credited the adaptive step size procedure, which they called `Adaptive Step-Size Random Search' \cite{Schumer1968}. Their approach modified the step size based on an approximation of the optimal step size required to reach the global optima.
...
need a due diligence procedure for investigating a technique
