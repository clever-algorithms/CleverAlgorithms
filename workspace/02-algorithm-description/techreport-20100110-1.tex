...
\begin{itemize}
	...
	\item \emph{References}: Mention of Kirkpatrick et al. and Metropolis et al. as the primary and seminal sources, additionally introductory articles on the algorithm and popular books on the field.
\end{itemize}
