...
% the listing
\lstinputlisting[firstline=7,language=ruby,caption=Genetic Algorithm in the Ruby Programming Language using the Functional Programming Paradigm, label=ga_functional]{../../src/programming_paradigms/functional.rb}
