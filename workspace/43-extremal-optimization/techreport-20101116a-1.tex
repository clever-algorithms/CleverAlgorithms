...
The implementation of the $\tau$-Extremal Optimization algorithm in the Ruby programming language require some additional work to provide an effective demonstration.
