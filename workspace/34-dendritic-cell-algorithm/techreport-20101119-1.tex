...
% algorithm
The algorithm is an implementation of the Deterministic Dendritic Cell Algorithm (dDCA) concisely described in \cite{Stibor2009}, with verification from \cite{Greensmith2008}.
