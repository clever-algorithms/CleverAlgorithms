...
Algorithm~\ref{alg:train} provides a pseudo-code for training the Perceptron. 
...
\begin{itemize}
	...
	\item The learning rate controls the amount of change each error has on the system, lower learning rages are common such as 0.1.
