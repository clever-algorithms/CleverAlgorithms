...
\section{Problems}
\label{sec:problems}
Two problem formalisms that embody many of the most difficult problems faced by Artificial and Computational Intelligence are reviewed: Function Optimization in Section~\ref{subsec:function_optimization} and Function Approximation in Section~\ref{subsec:function_approximation}. Each formalism is described in terms of its general properties, a formalism, and a set of specialized sub-problems. These problem classes provide a tangible framing if algorithmic techniques drawn from the fields of Computational Intelligence, Natural Computing, and Metaheuristics.
