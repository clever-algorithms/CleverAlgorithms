...
% context
This selection provides an overview of so-named `Unconventional Optimization Algorithms' which comprise the approaches selected for description in the Clever Algorithms project. These algorithms were drawn from the fields of Computational Intelligence, Natural Computation, and Metaheuristics. 
...
Unconventional optimization algorithms are applied to difficult problems that 
