...
% concern overview
The techniques selected for inclusion in the project are predominately for function optimization and have been described as unconventional optimization algorithms. 
% report
...
% problems
A set of general attributes of difficult problems are described that motivate the need for heuristic methods. Two general classes of problems are introduced, including function optimization and function approximation, that latter of which can sometimes be phrased as an optimization problem.
% algorithms
