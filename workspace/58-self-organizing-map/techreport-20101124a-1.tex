...
Self-Organizing Map, SOM, Kohonen Map, Kohonen Network
...
It is related to other competitive learning neural networks such as the the Learning Vector Quantization algorithm that is a similar algorithm for classification without connections between the neurons. 
