...
approach: TSP, Berlin52, stochastic 2-opt as the local search, number of applications of the procedure as the neighbourhood structure. stop condition will be the number iterations without improvement. just a demonstration of the strategy.
...
% other approaches
Some names of additional techniques encountered while researching this report include: \emph{Adaptive Multi-start}, \emph{Variable Depth Search}, 
