...
\begin{itemize}
	...
	\item (seminal?) Variable neighbourhood search: Principles and applications (2001)
	\item (seminal?) Variable neighbourhood search (2002)
	\item (seminal?) Variable neighbourhood search (2003)
\end{itemize}
