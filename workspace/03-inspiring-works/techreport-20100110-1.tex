...
\begin{itemize}
	...
	\item \emph{The example}: Commonly a listing of the matching procedure on a specific problem instance, depicting the algorithms behaviour graphically for each iteration until the example problem is solved.
