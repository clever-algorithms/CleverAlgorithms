...
O'Reilly cook book series - quick solutions for common problems
specific use cases, lots and lots of them, ready to use code
down sides, makes you dumb, more people doing best practice things, or quick hacks/patches
\url{http://oreilly.com/store/series/cookbooks.csp}


\subsection{Java Developers Almanac}

terse solutions to common problems
lots of very specific code examples
search, locate the use case, implement it
has its down sides two
