...
% report
This report describes the Univariate Marginal Distribution Algorithm using the standardized algorithm description template.

\begin{description}
	\item[Keywords:] {\small\texttt{Clever, Algorithms, Description, Optimization, Univariate, \\Marginal, Distribution, Algorithm}}
\end{description} 
...
UMDA is closely related to the Factorized Distribution Algorithm (FDA) and was the basis for the extension algorithm called the Bivariate Marginal Distribution Algorithm (BMDA).
...
The information processing strategy of the algorithm is use the frequency of components in a population of candidate solutions to control the construction of new candidate solutions.
...
% seminal
The Univariate Marginal Distribution Algorithm was described by M\"uhlenbein in 1997 \cite{Muhlenbein1997}.
% early
