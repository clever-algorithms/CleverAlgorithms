...
\newcommand{\myreportdate}{20101123}
...
% implementation
An implementation of the algorithm was adapted although could not be resolved within the time constraints. It is expected that an implementation can be provided with further study of the seminal references, the book, and the sample C++ code provided by Pelikan.
