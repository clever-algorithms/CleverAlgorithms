...
\begin{itemize}
	...
	\item The fitness of constructed bayesian networks may be assessed using the Bayesian Dirichlet Metric (BD) or the Minimum Description length method called the Bayesian Information Criterion (BIC).
