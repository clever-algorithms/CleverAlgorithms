...
\begin{itemize}
	...
	\item Bayesian networks are typically constructed (grown) from scratch each iteration using an iterative process of adding, removing, and reversing links. Additionaly, past networks may be used as the basis for the process that are in turn verified.
	...
	\item The fitness of constructed bayesian networks may be assessed using...
