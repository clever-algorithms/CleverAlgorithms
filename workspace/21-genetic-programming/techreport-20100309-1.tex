...
Listing~\ref{genetic_programming} provides an example of the Genetic Programming algorithm implemented in the Ruby Programming Language. 
% problem
The problem...todo

based on \cite{Koza2003a}
...
terminals include input x and R real constant in [-5,5]
functions include four arimethic operators
divide will return 0 when a divide by zero is attempted
fitness is error, likely ABS or RMS

cfg 0.9 for crossover, 0.08 for reproduction?, 0.01 for mutation, 0.01 for architecture altering operations?
