...
% difficult
This algorithm was particularly difficult to describe given the large amount detailed pseudo code examples used in the literature to present the approach and the general complexity of the algorithm. 
