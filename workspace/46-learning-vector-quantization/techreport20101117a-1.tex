...
\begin{description}
	\item[Keywords:] {\small\texttt{Clever, Algorithms, Description, Optimization, Learning, Vector, Quantization}}
\end{description} 
...
Learning Vector Quantization is related to the Kohonen Self-Organizing Map which is essentially the same algorithm with the addition of a connections between the neurons. Additionally, LVQ is a baseline technique that was defined with a few variants LVQ1, LVQ2, LVQ3 and OLVQ, as well as many third-party extensions and refinements too numerous to list.
