...
\begin{itemize}
	\item (initially proposed) using surrogate constraints on integer programming problems \cite{Glover1977}
	...
	\item (seminal overview) \cite{Glover1989} (follow up to seminal!) \cite{Glover1990}
\end{itemize}
