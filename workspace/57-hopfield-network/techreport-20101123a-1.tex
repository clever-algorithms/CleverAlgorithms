...
sliding down an energy surface - energy is a metaphor from biological system
...
all about storing patterns and returning them given some cues 
...
all neurons are input and output
