...
% also
i want to see a tech report that is a lot more aggressive in the use of the work product from this project
- refs are useful to know which primary sources to read and cites if the algorithm is used
- strategy can be read and interpreted for a specific application need
- implementations there for direct adaption to a problem for comparison or investigation
- all about saving time, jumpstarting use of these algorithms, not about being exhaustive 
