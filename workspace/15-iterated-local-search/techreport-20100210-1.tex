...
This report describes the Iterative Local Search algorithm using the standardized template.
% conclusions
Section~\ref{sec:conclusions} suggests some areas for future consideration for the Clever Algorithms project that arose during the preparation of the report.
