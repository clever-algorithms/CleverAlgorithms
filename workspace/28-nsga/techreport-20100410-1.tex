...
\newcommand{\myreportdate}{20100410}
...
Non-dominated Sorting Genetic Algorithm, Nondominated Sorting Genetic Algorithm, NSGA, NSGA-II, NSGAII
...
related to Vector-Evaluated Genetic Algorithm
Strength Pareto Evolutionary Algorithm
and Pareto Archived Evolution Strategy

% taxonomy
two versions, NSGA and NSGA II
...
proposal of NSGA \cite{Srinivas1994}
ranking selection method to focus on good points
niching method to maintain stable sub-populations



proposal of NSGA II \cite{Deb2002}, no actually in \cite{Deb2000}
...
% books
Deb's extensive book on MOO with EA's \cite{Deb2001}
covers nsga in chapter 5 (page 209)
...
see here for all the refs \cite{Konak2006}
...
Region-based Selection in Evolutionary Multiobjective Optimization (PESA-II)
