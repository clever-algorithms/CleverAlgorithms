...
It is related to other Evolutionary Multiple Objective Optimization Algorithms (EMOO) such as the Vector-Evaluated Genetic Algorithm (VEGA), Strength Pareto Evolutionary Algorithm (SPEA), and Pareto Archived Evolution Strategy (PAES).
% taxonomy
