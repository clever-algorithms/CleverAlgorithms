...
%  cfg
The algorithm uses a binary string representation (16 bits per objective function parameter) that is decoded using the binary coded decimal method and rescaled to the function domain. A fixed mutation rate of $\frac{1}{L}$ is used, where $L$ is the number of bits in a solution's binary string.
