...
The name refers to the backward propagation of error during the training of the network. 
...
% report
This report described the Backpropagation algorithm using the standardized algorithm template.
