...
is: GLS
\begin{itemize}
	\item can use first improvement or best improvement local search techniques
	\item guided local search (tech report) (1995)
	\item (seminal!) GENET generalized to Guided Local Search for Combinatorial Optimisation Problems (1997)
	\item (seminal!): Partial Constraint Satisfaction Problems and Guided Local Search (1996)
	\item (seminal?): Fast local search and guided local search and their application to British Telecom's workforce scheduling problem (1997)
	\item Guided local search joins the elite in discrete optimisation (1998)
	\item Solving the Radio Link Frequency Assignment Problem using Guided Local Search (1998)
	\item Guided local search applied to the satisfiability (SAT) problem (1999)
	\item Guided Local Search and its application to the Travelling Salesman Problem (1999)
	\item Guided local search (2003) in Glovers metaheuristic book
\end{itemize}


extensions: extended guided local search, guided genetic search
\begin{itemize}
	\item characterized and extended GLS: Extensions To Guided Local Search (2002)
...
article in glover's book provides a contemporary overview of the technique and its areas of application, and provides a detailed example of the approach allied to the TSP, quadratic assignment, workforce scheduling, and the radio link frequency assignment problem.
