...
\begin{itemize}
	\item Binary strings (bitstrings) are the classical representation as they can be decoded to almost any desired representation. Real-valued variables can be decoded using the binary coded decimal method or the gray code method, the latter of which is generally preferred.
	...
	\item The algorithm is highly-modular and a sub-field exists to study each sub-process, such as selection, recombination, mutation, and representation. 
