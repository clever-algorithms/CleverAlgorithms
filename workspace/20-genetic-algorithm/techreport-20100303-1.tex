...
The objective of the Genetic Algorithm is to improve the adaptive fit of a population of candidate solutions to an environment defined by an cost function. 
