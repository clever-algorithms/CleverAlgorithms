...
\begin{itemize}
	...
	\item The size of the population must be large enough to provide sufficient coverage of the domain and mixing of the useful sub-components of the solution. The population size may be configured to be a factor of the number of components in the solution.
	...
	\item The algorithm is highly-modular and a sub-field exists to study each component and problem specific operators are suggested, although the following are recommended operators for a binary string representation: Tournament Selection for the selection operator, one-point or two-point crossover for the recombination operator, and point mutations for the mutation operator. 
\end{itemize}
