...
belong to evolutionary computation
sibling of evolutionary algorithms such as ES, GP, EP, LCS
parent of a large field of study
...
based on population genetics (heredity and evolution at population level) and mendelian view of the mechanisms (chromosomes, genes), haploid models (single chromosome), or polyploid (multiple chromosomes)
...
objective adapt to the environment
% What is a techniques plan of action?
assess, select, recombine 
...
\begin{algorithm}[htp]
	...
	\SetKwData{Current}{$S_{i}$}
	\SetKwData{CurrentFitness}{$Si_{fitness}$}
	\SetKwData{Population}{Population}
	\SetKwData{ProblemSize}{ProblemSize}
	\SetKwData{PopulationSize}{$Population_{size}$}
	\SetKwData{BoutSize}{$Bout_{size}$}
	...
	\KwOut{\Best}
  	% Algorithm
	\Population $\leftarrow$ \InitializeRandomBitstrings{\PopulationSize, \ProblemSize}\;
	
	
	\ForEach{\Current $\in$ \Population}{
		\CurrentFitness $\leftarrow$ \EvaluateFitness{\Current}\;
		\If{}{
