...
The algorithm has a conservative configuration with regard to genetic operators, including binary tournament selection for the selection operator, uniform crossover for the recombination operator, and point mutations for the mutation operator.
