...
\newcommand{\myreportdate}{20100328}
...
seminal was a tech report by Storn and Price \cite{Storn1995} later published as a journal article \cite{Storn1997}
...
nice overview \cite{Price1997}

good overview of application to func opt \cite{Storn1996}


books
great intro chapter in \cite{Price1999}

2005 book \cite{Price2005} - technique in depth, benchmarks, sample code, application samples

2008 technical book \cite{Chakraborty2008}, review and extensions to address complexities such as stopping criteria, rotation invariance 
