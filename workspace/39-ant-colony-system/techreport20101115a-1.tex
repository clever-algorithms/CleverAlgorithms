...
\begin{description}
	\item[Keywords:] {\small\texttt{Clever, Algorithms, Description, Optimization, Ant, Colony, Sytem}}
\end{description} 
...
The procedure is different to Ant Systems in three specific ways, as follows:
\begin{itemize}
	\item Evaporation occurs after each candidate solution is created.
	\item Update and decay processes are only applied to the components of the best tour found so far in each iteration.
	\item Local pheromone update for each new solution created.
\end{itemize}
...
% seminal
The algorithm was proposed in a technical report by Dorigo and Gambardella \cite{Dorigo1997a}, and was later published \cite{Dorigo1997}.
% early
