...
\begin{itemize}
	...
	\item overview? A survey of random methods for parameter optimization, 1971
\end{itemize}
...
also... complete, consistent, etc ideals of the project are bounded. complete enough too.. consistent enough so that... centralized ... - sections are not exhaustive, neither are descriptions. there are specific bounded goals.
