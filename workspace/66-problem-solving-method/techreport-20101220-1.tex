...
The global search provides the benefit of making few if any assumptions about where promising areas of the search space may be, potentially highlighting unintuitive combination's of parameters. The local search provides the benefit if focus and refinement of an existing candidate solution.
