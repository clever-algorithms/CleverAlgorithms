...
def write_result_file(mutation, output_file)
  rs = ""
  100.times do |i|
    best = perform_run(mutation)
    rs << "#{best[:fitness]}\n"
  end
  File.open(output_file, "w") {|f| f.write(rs)}
  puts "wrote #{output_file}"
end

if __FILE__ == $0  
  write_result_file(1.0/300.0, "ga_rs1.txt")
  write_result_file(10.0/300.0, "ga_rs2.txt")
  write_result_file(100.0/300.0, "ga_rs3.txt")
  puts "done"
end
