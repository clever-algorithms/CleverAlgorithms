...
Algorithm~\ref{alg:scatter_search} provides a pseudo-code listing of the Scatter Search algorithm for minimizing a cost function.

scatter search does not have a specific form - rather it describes an abstract procedure. can specify it with operator and domain specific functions

this section presents the abstract form of the approach.
...
\begin{itemize}
	\item prefer small population sizes (such as 20 solutions or less)
...
what is path relinking? why is it relevant?
\begin{itemize}
	\item 
\end{itemize}
